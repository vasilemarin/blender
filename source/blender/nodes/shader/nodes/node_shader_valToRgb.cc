...
class ColorBandFunction : public blender::fn::MultiFunction {
 ...
 public:
  ...
  static blender::fn::MFSignature create_signature()
  {
    ...
    signature.single_output<blender::ColorGeometry>("Color");
            ...
            blender::fn::MFContext UNUSED(context)) const override
  {
    ...
    blender::MutableSpan<blender::ColorGeometry> colors =
        params.uninitialized_single_output<blender::ColorGeometry>(1, "Color");
    blender::MutableSpan<float> alphas = params.uninitialized_single_output<float>(2, "Alpha");

    for (int64_t i : mask) {
      blender::ColorGeometry color;
