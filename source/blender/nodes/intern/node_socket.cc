...
static bNodeSocketType *make_socket_type_rgba()
{
  ...
  socktype->get_cpp_type = []() { return &blender::fn::CPPType::get<blender::ColorGeometry>(); };
  socktype->get_cpp_value = [](const bNodeSocket &socket, void *r_value) {
    *(blender::ColorGeometry *)r_value = ((bNodeSocketValueRGBA *)socket.default_value)->value;
  };
  return socktype;
}
