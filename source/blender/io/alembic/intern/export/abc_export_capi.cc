                ...
                bool as_background_job)
{
  ...
  ABC::ExportJobData *job = static_cast<ABC::ExportJobData *>(
      MEM_mallocN(sizeof(ABC::ExportJobData), "Alembic ExportJobData"));
  ...
  if (as_background_job) {
    ...
    WM_jobs_callbacks(wm_job, ABC::export_startjob, NULL, NULL, ABC::export_endjob);
    ...
    ABC::export_startjob(job, &stop, &do_update, &progress);
    ABC::export_endjob(job);
