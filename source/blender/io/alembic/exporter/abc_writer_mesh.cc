...
Alembic::Abc::OCompoundProperty ABCGenericMeshWriter::abc_user_props()
{
  if (is_subd_) {
    return abc_subdiv_schema_.getUserProperties();
  }
  return abc_poly_mesh_schema_.getUserProperties();
}
