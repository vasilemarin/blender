...
void GpuEvalOutput::wrapPatchArraysBuffer(OpenSubdiv_Buffer *patch_arrays_buffer)
{
...
void GpuEvalOutput::wrapFVarPatchArraysBuffer(const int face_varying_channel,
                                              OpenSubdiv_Buffer *patch_arrays_buffer)
{
